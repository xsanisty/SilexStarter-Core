...
class ConfigurationContainerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $stubs  = require __DIR__.'/../stubs/test_config/app.php';
    ...
    public function test_load_app_config()
    {
        $this->config->load('app');

        assertEquals('test_value', $this->app['test_config']);
    }
